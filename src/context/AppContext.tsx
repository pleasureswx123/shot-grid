...
interface AppContextType {
  ...
  uploadVersionFile: (file: File, metadata: { taskId: string; versionNumber: string; fileType: Version['fileType']; thumbnailUrl?: string; changelog?: string; aiParams?: unknown }) => Promise<ProjectFile>;
...
export const AppProvider: React.FC<AppProviderProps> = ({
  ...
  const uploadVersionFile = async (file: File, metadata: { taskId: string; versionNumber: string; fileType: Version['fileType']; thumbnailUrl?: string; changelog?: string; aiParams?: unknown }) => {
